...
export default function PostArticle() {
  ...
  return (
    <Layout>
      <div className="min-[320px]:px-4 min-[320px]:py-8 md:px-8	md:py-10  lg:pb-12">
        <Article {...data.postData} />
        <div className="border-t-[#E6E6E6 ] mx-auto max-w-[1224px] min-[320px]:block md:hidden lg:block">
